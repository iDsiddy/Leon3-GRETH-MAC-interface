...
set XDIRSKIP {b1553 pci/pcif leon2 leon2ft crypto satcan pci leon3ft ambatest ddr leon4v0 l2cache/v2 l2cache/v3 l2cache/str gr1553b iommu ascs slink pwm ge_1000baseX canfd leon5v0 leon5v0/blockred grfpu5 noelv noelv/subsys riscv b1553/core pci/pcif/core leon2/core leon2ft/core crypto/core satcan/core pci/core leon3ft/core ambatest/core ddr/core leon4v0/core l2cache/v2/core l2cache/v3/core l2cache/str/core gr1553b/core iommu/core ascs/core slink/core pwm/core ge_1000baseX/core canfd/core leon5v0/core leon5v0/blockred/core grfpu5/core noelv/core noelv/subsys/core riscv/core core1553bbc core1553brm core1553brt gr1553 corePCIF tmtc openchip hynix cypress ihp gsi fmf spansion core1553bbc core1553brm core1553brt gr1553 corePCIF tmtc openchip hynix cypress ihp gsi fmf spansion dummy}
set GRLIB_CONFIG {dummy}
set XFILESKIP {grcan.vhd adapters/sgmii.vhd sf2apbslv_wrapper.vhd sf2ficmst_wrapper.vhd sf2ficslv_wrapper.vhd sf2mddr_wrapper.vhd pfmddr_wrapper.vhd *_core1553bbc.vhd *_core1553brm.vhd *_core1553brt.vhd *_gr1553.vhd *_corePCIF.vhd *_tmtc.vhd *_openchip.vhd *_hynix.vhd *_cypress.vhd *_ihp.vhd *_gsi.vhd *_fmf.vhd *_spansion.vhd dummy MCB.vhd GTXE1.vhd GTP_DUAL.vhd GTPA1_DUAL.vhd GT11.vhd GT11CLK.vhd GT11CLK_MGT.vhd GT11_CUSTOM.vhd GT11_DUAL.vhd GTX_DUAL.vhd GTHE1_QUAD.vhd PCIE_2_0.vhd PCIE_A1.vhd}
set VHDLANOPT {}
set VLOGANOPT {}
set SVLOGANOPT {}
